...
{{block name=head_style}}
	<link rel="stylesheet" href="{{$Url}}libraries/fontawesome/css/svg-with-js.min.css" />
	{{block name=install_head_style}}{{/block}}
{{/block}}
{{block name=head_script}}
	<script src="{{$Url}}libraries/fontawesome/js/all.min.js"></script>
	<script src="{{$Url}}libraries/fontawesome/js/fontawesome.min.js"></script>
