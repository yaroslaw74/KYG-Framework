...
define('KYG_PATH_COMPONENTS', KYG_PATH_BASE . 'components' . DIRECTORY_SEPARATOR);
...
define('KYG_PATH_LANGUAGES', KYG_PATH_BASE . 'languages' . DIRECTORY_SEPARATOR);
define('KYG_PATH_LIBRARIES', KYG_PATH_BASE . 'libraries' . DIRECTORY_SEPARATOR);
define('KYG_PATH_MODULES', KYG_PATH_BASE . 'modules' . DIRECTORY_SEPARATOR);
define('KYG_PATH_PLUGINS', KYG_PATH_BASE . 'plugins' . DIRECTORY_SEPARATOR);
...
//define('KYG_PATH_', KYG_PATH_BASE . '' . DIRECTORY_SEPARATOR);
...
//define('KYG_PATH_', KYG_PATH_COMPONENTS . '' . DIRECTORY_SEPARATOR);
