...
class ArrayAccessService
{
    ...
    {
        $languages = Yaml::parseFile($this->params->get('app.modules_dir') . '/Install/Resources/data/languages.yaml');
        return $languages['languages'];
    }
    public function getExtensions(): array
    {
        $extensions = Yaml::parseFile($this->params->get('app.modules_dir') . '/Install/Resources/data/extensions.yaml');
