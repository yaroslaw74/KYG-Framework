...
class ArrayAccessService
{
    ...
    public function getLanguages(string $Language): array
    {
        ...
        foreach ($languages['languages'] as $key => $Value) {
            $languages['languages'][$key]['translation'] = $this->translator->trans( 'languages.' . $key, [], 'languages', $Language);
        }
        return $languages['languages'];
    }
    public function getExtensions(): array {
        $extensions = Yaml::parseFile($this->params->get('app.modules_dir') . '/Install/Resources/yaml/extensions.yaml');
